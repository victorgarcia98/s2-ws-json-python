...
class TimerTest(TestCase):
    def test__from_json__happy_path(self):
        # Arrange
        json_str = '{"id": "2bdec96b-be3b-4ba9-afa0-c4a0632ccedf", "duration": 5000, "diagnostic_label": "some_label"}'  # noqa: E501

        # Act
        timer = Timer.from_json(json_str)
        # TODO Why does mypy think Timer here is of type Any and not Timer?
        # timer.famma() should raise a pycharm error, but that does not work either.
        # Weirdly, autocompletion on timer.<> seems to work.
        #   reveal_type(timer)
    ...
    def test__from_json__format_validation_error(self):
        # Arrange
        json_str = '{"id": "2bdec96b-be3b-4ba9-afa0-c4a0632ccedf", "diagnostic_label": "some_label"}'  # noqa: E501
    ...
    def test__from_json__validator_error(self):
        # Arrange
        json_str = '{"id": "2bdec96b-be3b-4ba9-afa0-c4a0632ccedf", "duration": 5000, "diagnostic_label": "som-e_label"}'  # noqa: E501
    ...
    def test__to_json__happy_path(self):
        ...
        # Assert
        expected_json = '{"id": "2bdec96b-be3b-4ba9-afa0-c4a0632ccedf", "diagnostic_label": "some_label", "duration": 5000}'  # noqa: E501
